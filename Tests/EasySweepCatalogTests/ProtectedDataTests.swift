...
struct ProtectedDataTests {
    @Test func expandedCachesAreCountedOnceWithoutSelectingNeighboringData() throws {
        let caches: [String: String] = [
            ...
            ".cache/puppeteer/chrome/.metadata": "puppeteer-browsers",
            ".cache/puppeteer/chrome-headless-shell/mac_arm-version/headless_shell": "puppeteer-browsers",
            ".cache/puppeteer/chromium/mac-version/chrome": "puppeteer-browsers",
            ".cache/puppeteer/firefox/mac_arm-version/firefox": "puppeteer-browsers",
            ".cache/puppeteer/chromedriver/mac-version/chromedriver": "puppeteer-browsers",
        ...
        let protected = [
            ...
            ".cache/puppeteer/new-store/profile/preferences.json",
            ".cache/puppeteer/custom-browser/profile/bookmarks.json",
            ".cache/puppeteer/settings.json",
